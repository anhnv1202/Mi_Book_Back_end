...
import { LIMIT_PER_PAGE } from '@common/constants/global.const';
import { FindManyOptions, Repository } from 'typeorm';
import CoreEntity from './base.entity';
import { TypeOrmPaginator } from './base.type';

abstract class BaseRepository<E extends CoreEntity> extends Repository<E> {
  async findAll(): Promise<E[] | undefined> {
  ...
  async paginate(page = 1, limit = LIMIT_PER_PAGE, options?: FindManyOptions<E>): Promise<TypeOrmPaginator<E>> {
